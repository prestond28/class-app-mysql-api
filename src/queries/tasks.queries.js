...
// Get every task
export const ALL_TASKS = `SELECT * FROM tasks`;

// Get a single task by id
export const SINGLE_TASK = `SELECT * FROM tasks WHERE id = ?`;
 ...
 */
export const INSERT_TASK = `INSERT INTO tasks (name) VALUES (?)`;
 ...
 */
export const UPDATE_TASK = `UPDATE tasks SET name = ?, status = ? WHERE id = ?`;
